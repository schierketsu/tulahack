...
declare class YMapClusterer extends ymaps3.YMapComplexEntity<YMapClustererProps, DefaultProps> {
    ...
    /** @internal */
    static [ymaps3.overrideKeyReactify]: import("@yandex/ymaps3-types/reactify/reactify").CustomReactify<YMapClusterer, import("react").ForwardRefExoticComponent<{
        tickTimeout?: number;
        method: IClusterMethod;
        features: Feature[];
    ...
    } & import("react").RefAttributes<YMapEntity<{
        tickTimeout?: number;
        method: IClusterMethod;
        features: Feature[];
        onRender?: (clusters: ClustererObject[]) => false | void;
    ...
    static [ymaps3.overrideKeyVuefy]: import("@yandex/ymaps3-types/modules/vuefy").CustomVuefyFn<YMapClusterer>;
    static [ymaps3.optionsKeyVuefy]: import("@yandex/ymaps3-types/modules/vuefy").CustomVuefyOptions<YMapClusterer>;
